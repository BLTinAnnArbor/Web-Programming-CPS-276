...
function init(){
  ...
  if(isset($_POST['submit'])){
    ...
    /* THE ELEMENTS ARRAY HAS A MASTER STATUS AREA. IF THERE ARE ANY ERRORS FOUND, THE STATUS IS CHANGED
     TO ERRORS FROM THE DEFAULT OF NOERRORS. WHAT IS RETURNED DETERMIMES WHAT HAPPENS 
     NEXT.  IN THIS CASE, THE RETURN MESSAGE HAS NO ERRORS SO WE HAVE NO PROBLEMS WITH OUR VALIDATION
...
/*THIS IS THE GET FORM FUNCTION, WHICH WILL BUILD THE FORM BASED UPON UPON THE 
